...
# Data Discovery Partner Portal Guide
...
Check your inbox for a one-time password (OTP) sent to your registered email address. Enter the 6-digit code in the boxes provided, then click **"Confirm"**.
